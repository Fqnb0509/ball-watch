...
export const matches: Match[] = [
  ...
  { id: 'youtube-savannah-bananas-test', sport: 'baseball', league: 'YouTube 官方直播测试', round: '官方公开视频测试', homeTeam: team('texas-tailgaters', 'Texas Tailgaters', 'TEX'), awayTeam: team('savannah-bananas', 'Savannah Bananas', 'SAV'), startTime: when(0, 12), date: when(0, 12), status: 'finished', venue: 'Historic Grayson Stadium', logo: '', description: '真实 YouTube 官方直播测试数据（公开视频）', streamIds: ['youtube-savannah-bananas-test'] },
